...
require_once 'Mage/Adminhtml/controllers/Sales/OrderController';

class  Efulfilment_BizzyBee_Sales_OrderController extends Mage_Adminhtml_Sales_OrderController
{
    /**
    ...
    public function cancelAction()
    {
		...
		//$helper = Mage::helper('Efulfilment/order')->workMyHelper();
